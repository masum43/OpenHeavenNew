...
public class AdsManager {
    ...
    public static void bannerAd(Activity activity, FrameLayout bannerContainer){
    ...
    public static void bannerDismiss(){
        if(banner != null){
            IronSource.destroyBanner(banner);
        }
    }

    public static void loadIntersAd(Activity activity){
    ...
    public static void loadShowIntersAd(Activity activity){
        IronSource.setInterstitialListener(new InterstitialListener() {
            /**
             * Invoked when Interstitial Ad is ready to be shown after load function was called.
             */
    ...
    public static void showNativeAd(Activity activity) {
        ...
        AdLoader adLoader = new AdLoader.Builder(activity, activity.getResources().getString(R.string.admob_native))
                .forNativeAd(new NativeAd.OnNativeAdLoadedListener() {
                    ...
                    public void onNativeAdLoaded(NativeAd ad) {
                        ...
                        FrameLayout frameLayout =
                                activity.findViewById(R.id.native_container);
...
/*
    ...
    public static void showNativeAd2(Activity activity) {

        AdLoader adLoader = new AdLoader.Builder(activity, activity.getResources().getString(R.string.nativeAd))
                .forNativeAd(new NativeAd.OnNativeAdLoadedListener() {
                    @Override
                    public void onNativeAdLoaded(NativeAd ad) {
                        // Show the ad.
                        ...
                        // (with id fl_adplaceholder) where the ad is to be placed.
                        FrameLayout frameLayout =
                                activity.findViewById(R.id.native_container2);
                        // Assumes that your ad layout is in a file call native_ad_layout.xml
                        // in the res/layout folder
                        NativeAdView adView = (NativeAdView) activity.getLayoutInflater()
                                .inflate(R.layout.native_ad, null);
